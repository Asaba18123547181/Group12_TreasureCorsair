...
model = YOLO("C:/Users/ASUS/Desktop/miniterm/yolov8-minimal-train-demo/yolov8/final.pt")  # load a pretrained model (recommended for training)
...
#print(results)
# '''
img_path = "C:/Users/ASUS/Desktop/testImage(1)/testImage"

results = model.predict( save=True,conf=0.5,save_txt=True) # device=0 by default, conf:置信度阈值
